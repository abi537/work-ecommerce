                ...
                <Box >
                    ...
                    <Box sx={{ mt: "10px" }}>
                        <Typography variant="grayText" component="p" sx={{
                            ...
                            Old school heritage Shop offers trendy apparel through its user-friendly e-commerce platform, blending style, convenience, and quality for fashion enthusiasts worldwide.
                        </Typography>
                    </Box>
                </Box>
            </Grid>
