...
class ProductApi {
  ...
  GetSearchProducts(data) {
    return this.request('get', `/oldShop/search?page=${data.page}&query=${data.query}&category=${data.category}&price=${data.price}&sort=${data.sort}&brand=${data.brand}&size=${data.size}`);
  }
